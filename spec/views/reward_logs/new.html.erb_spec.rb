...
RSpec.describe "reward_logs/new", type: :view do
  before(:each) do
    assign(:reward_log, RewardLog.new(
      :reward => nil,
      :customer => nil,
      :merchant => nil,
      :amount => "MyString",
  ...
  it "renders new reward_log form" do
    render

    assert_select "form[action=?][method=?]", reward_logs_path, "post" do
