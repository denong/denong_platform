...
ActiveRecord::Schema.define(version: 20150328003154) do
  ...
  create_table "jaajins", force: true do |t|
    t.float    "got"
    t.float    "unverify"
    t.integer  "customer_id"
    t.datetime "created_at"
  ...
  add_index "jaajins", ["customer_id"], name: "index_jaajins_on_customer_id"
